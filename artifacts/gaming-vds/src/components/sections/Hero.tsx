...
export function Hero() {
  ...
  return (
    <section className="relative w-full pt-32 pb-24 flex flex-col items-center justify-center min-h-[90vh] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[120px] -z-10" pointer-events-none="true" />
      ...
      <div className="container mx-auto px-4 flex flex-col items-center text-center z-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8 border-y border-[#3c3c3c] py-6 px-8 max-w-5xl bg-black">
