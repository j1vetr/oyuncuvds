...
export function Hero({ onOpenOrder }: HeroProps) {
  return (
    <section className="relative w-full bg-white pt-16 md:pt-20 pb-16 md:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-8 items-center">
          ...
          <div className="relative">
            ...
            <h1 className="display-headline text-[40px] sm:text-[52px] lg:text-[64px] xl:text-[72px] text-[#0a0b0d] leading-[1.05] mb-6">
              Bilgisayarın
              <br />
              kapalıyken
              <br />
          ...
          <div className="relative w-full">
            ...
            <div
              className="hidden md:flex absolute -top-2 right-0 z-20 items-center gap-3 bg-white rounded-2xl border border-[#dee1e6] shadow-[0_8px_24px_rgba(15,23,42,0.06)] px-4 py-3 max-w-[200px]"
            ...
            <div
              className="hidden md:flex absolute top-[45%] right-0 z-20 items-center gap-3 bg-white rounded-2xl border border-[#dee1e6] shadow-[0_8px_24px_rgba(15,23,42,0.06)] px-4 py-3 max-w-[200px]"
            ...
            <div
              className="hidden md:flex absolute bottom-4 right-2 z-20 items-center gap-3 bg-white rounded-2xl border border-[#dee1e6] shadow-[0_8px_24px_rgba(15,23,42,0.06)] px-4 py-3 max-w-[220px]"
            ...
            <div
              className="hidden md:flex absolute top-6 left-0 z-20 items-center gap-3 bg-white rounded-2xl border border-[#dee1e6] shadow-[0_8px_24px_rgba(15,23,42,0.06)] px-4 py-3 max-w-[200px]"
            ...
            <div
              className="hidden md:flex absolute bottom-16 left-0 z-20 items-center gap-3 bg-white rounded-2xl border border-[#dee1e6] shadow-[0_8px_24px_rgba(15,23,42,0.06)] px-4 py-3 max-w-[220px]"
            ...
            <img
              ...
              className="relative z-10 w-full h-auto object-contain max-w-[680px] mx-auto"
              loading="eager"
              fetchPriority="high"
            />
          </div>
