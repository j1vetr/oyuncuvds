    ...
    <div className="min-h-screen bg-white text-[#0a0b0d] font-sans">
      <div className="border-b border-[#eef0f3] px-6 py-4 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3">
          <img src="/logo-v2.png" alt="Oyuncu VDS" className="h-14 md:h-16 w-auto" loading="eager" decoding="async" />
        </a>
      ...
      <main className="container mx-auto px-4 py-14 max-w-2xl">
        ...
        <div className="space-y-8 text-[#5b616e] text-[14px] leading-[1.85]">
          ...
          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">1. Satıcı Bilgileri</h2>
            <p>
              <strong className="text-[#0a0b0d]">Ünvan:</strong> {COMPANY}<br />
              <strong className="text-[#0a0b0d]">Adres:</strong> {ADDRESS}<br />
              <strong className="text-[#0a0b0d]">E-posta:</strong> {EMAIL}<br />
              <strong className="text-[#0a0b0d]">Telefon:</strong> {PHONE}
            </p>
          </section>

          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">2. Hizmetin Temel Nitelikleri</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">3. Hizmet Paketleri ve Fiyatlar</h2>
            <div className="space-y-3">
              <div className="border border-[#dee1e6] rounded-2xl p-4">
                <p className="text-[#0a0b0d] font-semibold mb-1">Baslangic Paketi</p>
              ...
              <div className="border border-[#dee1e6] rounded-2xl p-4">
                <p className="text-[#0a0b0d] font-semibold mb-1">Performans Paketi</p>
                <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">4. Ödeme Koşulları</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">5. Teslimat</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">6. Cayma Hakkı</h2>
            <p>
            ...
            <p className="mt-2">
              Hizmet ifa edilmeden önce cayma hakkı kullanılabilir. Cayma bildiriminin <a href={`mailto:${EMAIL}`} className="text-[#0052ff] hover:underline">{EMAIL}</a> adresine iletilmesi gerekmektedir.
            </p>
          </section>

          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">7. Şikayet ve Uyuşmazlık</h2>
            <p>
              Şikayetleriniz için <a href={`mailto:${EMAIL}`} className="text-[#0052ff] hover:underline">{EMAIL}</a> adresine yazabilir veya {PHONE} numaralı hattı arayabilirsiniz. Uyuşmazlıklar için İstanbul Tüketici Hakem Heyetleri ve Tüketici Mahkemeleri yetkilidir.
            </p>
          </section>

          <section>
            <h2 className="text-[#0a0b0d] font-semibold text-[16px] tracking-tight mb-3">8. Onay</h2>
            <p>
